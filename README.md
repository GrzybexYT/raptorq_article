...
- **Python Demos:**  
  Simple Python code examples are included to show how the encoding and decoding work under the hood. You can read the code, but you don’t need to run anything here.
...
- If the app won’t open, try restarting your computer and running it again.
